    ...
    if (targetOseId) {
      try {
        ...
        if (known) {
          ...
          trackingResult.comprobante_pdf = known.comprobante_pdf;
        }
      } catch (apiError: any) {
        ...
        trackingResult = {
          ...
          comprobante_pdf: known?.comprobante_pdf || 'https://www.nubefact.com/cpe/82b646ac-150e-484e-aa6e-969c6f9123fb.pdf',
          carguero: '1045277',
        };
      }
    } else {
